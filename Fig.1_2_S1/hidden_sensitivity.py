##########################################################################
# hidden_sensitivity.py: Data processing scripts
#
...
######################################################################################################################
def get_efret(idr,df,sel,base_corr_fact_df,TQ_data,NG_data,correct_base_spectra=True):
    print ('get_efret')
    ...
    R_naught=61.55 # Angstroms, from fpbase.org - dm 
    ...
    for col in sel:
        ...
        fretRes= fretRes.append({'idr':idr,'col':col,'sol':sol,'conc':conc,'E_f':E_f,
                                 ...
                                 'f_d':f_d,'f_a':f_a,'F_d':F_d,'F_s':F_s,'exp':y,
...
def get_all_idrs_chi_df():
    ...
    PUMA_efret_1=get_efret('PUMA',PUMA_data_1,range(3,PUMA_data_1.shape[1]),base_corr_fact_df,TQ_data,NG_data,True)
    PUMA_efret_2=get_efret('PUMA',PUMA_data_2,range(3,PUMA_data_2.shape[1]),base_corr_fact_df,TQ_data,NG_data,True)
    Ash1_efret_1=get_efret('Ash1',Ash1_data_1,range(3,Ash1_data_1.shape[1]),base_corr_fact_df,TQ_data,NG_data,True)
    Ash1_efret_2=get_efret('Ash1',Ash1_data_2,range(3,Ash1_data_2.shape[1]),base_corr_fact_df,TQ_data,NG_data,True)
    E1A_efret_1=get_efret('E1A',E1A_data_1,range(3,E1A_data_1.shape[1]),base_corr_fact_df,TQ_data,NG_data,True)
    E1A_efret_2=get_efret('E1A',E1A_data_2,range(3,E1A_data_2.shape[1]),base_corr_fact_df,TQ_data,NG_data,True)
    P53_efret_1=get_efret('p53',P53_data_1,range(3,P53_data_1.shape[1]),base_corr_fact_df,TQ_data,NG_data,True)
    P53_efret_2=get_efret('p53',P53_data_2,range(3,P53_data_2.shape[1]),base_corr_fact_df,TQ_data,NG_data,True)
    ...
    solutes = ['D-Sorbitol', 'Glycerol', 'Xylitol', 'Meso-Erythritol', 'D-Mannitol', 'Myo-Inositol',
               'EG', 'PEG200', 'PEG400', 'PEG1500', 'PEG2000', 'PEG4000', 'PEG6000', 'PEG8000', 'PEG10000',
               'Ficoll', 'Dextran', 'Glycine', 'L-Proline', 'Tricine', 'Sarcosine', 'BetaineH2O', 'L-Tryptophan',
    ...
    PUMA_chi_df_1 = convert_efret_df_to_chi_df('PUMA', PUMA_efret_1, gs_regress_slope, gs_regress_intercept, 34, 1, solutes)
    ...
    PUMA_chi_df_2 = convert_efret_df_to_chi_df('PUMA', PUMA_efret_2, gs_regress_slope, gs_regress_intercept, 34, 2, solutes)
    ...
    all_idrs_chi_df = pd.concat([GS0_chi_df_1,GS8_chi_df_1,GS16_chi_df_1,GS24_chi_df_1,GS32_chi_df_1,GS48_chi_df_1,
                                 PUMA_chi_df_1,Ash1_chi_df_1,E1A_chi_df_1,P53_chi_df_1,
                                 GS0_chi_df_2,GS8_chi_df_2,GS16_chi_df_2,GS24_chi_df_2,GS32_chi_df_2,GS48_chi_df_2,
                                 PUMA_chi_df_2,Ash1_chi_df_2,E1A_chi_df_2,P53_chi_df_2], ignore_index=True)
