#############################################################################
# Figure 2B: Chi vs. concentration for several IDRs focusing on a few solutes
#
...
#         print ('delta_chis_mean: ' + str(delta_chis_mean))
#         print ('delta_chis_stdev: ' + str(delta_chis_stdev))
#         print ('Xs: ' + str(Xs))
...
# plt.setp(axs, yticks=[-0.3, 0.0, 0.3])
